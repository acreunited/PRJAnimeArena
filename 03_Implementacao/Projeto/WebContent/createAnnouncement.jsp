...
<body>
    ...
    <section id="create">
    	...
    	<div id="prev" class="container" style="display:none;">
            ...
            <div class="containerAnnoucements">
                ...
                <div style="background-color: black;" class="text-start">
                	<div id="previewHere" class="textAnnInfo">
    	...
    	<div class="text-center">
	    	<form  id="form" action="Announcement">
		    	<input type="text" placeholder="Title" name="title" pattern="[A-Za-z\s]{1,32}" required/>
		    	<input type="text" placeholder="Category" name="category" pattern="[A-Za-z\s]{1,32}" required/><br>
		    	<label><b>Small description:</b></label><br>
		    	<textarea placeholder="Small description " name="smallDescription"
						style="min-height: 100px; width: 80%;" maxlength="100" required>
				</textarea><br>
				<label><b>Full Announcement:</b></label><br>
				<a onclick="addText('[img=/img]')" class="fas fa-image fa-sm fa-fw mr-2 text-gray-400"></a>
				<a onclick="addText('[b][/b]')" class="fas fa-bold fa-sm fa-fw mr-2 text-gray-400"></a>
				<a onclick="addText('[i][/i]')" class="fas fa-italic fa-sm fa-fw mr-2 text-gray-400"></a>
				<a onclick="addText('[color=red][/color]')" id="red">&#9632;</a>
				<a onclick="addText('[color=orange][/color]')" id="orange">&#9632;</a>
				<a onclick="addText('[color=yellow][/color]')" id="yellow">&#9632;</a>
				<a onclick="addText('[color=blue][/color]')" id="blue">&#9632;</a>
				<a onclick="addText('[color=purple][/color]')" id="purple">&#9632;</a>
				<a onclick="addText('[color=pink][/color]')" id="pink">&#9632;</a>
				<a onclick="addText('[color=green][/color]')" id="green">&#9632;</a>
				<br>
		    	<textarea id="fullAnnText" placeholder="Write Announcement" name="writeAnnouncement"
						style="min-height: 300px; width: 80%;" maxlength="50000" required>
				</textarea><br>
				<input type="hidden" name="action" value="create">
				
				<input type="image" id="image" alt="Login" src="img/Buttons/confirm_button.png">
			</form>
			<button id="btnPreview" onclick="showPreview()">PREVIEW</button><br>
    	</div>	
